...
interface LikeService {
    suspend fun toggle(userId: UserId, targetId: String, targetType: LikeTargetType): ToggleResult
...
class LikeServiceImpl(private val repo: LikeRepository) : LikeService {
    ...
    override suspend fun toggle(userId: UserId, targetId: String, targetType: LikeTargetType): ToggleResult {
